...
console.log("       - Compare Scopes of the var and let keywords:");
...
// var and let keywords assign scope to the declared variable. When 
// programming a function similar to the one used in this exercise, 
