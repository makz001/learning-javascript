...
// containing the squares of only the positive integers (decimal numbers are 
// not integers) when an array of real numbers is passed to it. An example of 
// an array of real numbers is [-3, 4.8, 5, 3, -3.2].
...
const squareList = arr => {
    ...
    return arr.filter(i => Number.isInteger(i) && i > 0)
        .reduce((a, i) => a.concat(Math.pow(i, 2)), []);
